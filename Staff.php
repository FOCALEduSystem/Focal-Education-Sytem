    ...
    <section>
        ...
        <table>
            <tr>
                ...
                <th>Email Address</th>
                <th>Role Id</th>
                <th class="add"><a href="StafAdd.php">Add</a></th>
            </tr>
            ...
            <tr>
                <!--FETCHING DATA FROM EACH 
                    ROW OF EVERY COLUMN-->
                <td><?php echo $rows['sta_ID'];?></td>
                <td><?php echo $rows['sta_fname'];?></td>
                <td><?php echo $rows['sta_lname'];?></td>
                <td><?php echo $rows['sta_telnum'];?></td>
                <td><?php echo $rows['sta_email'];?></td>
